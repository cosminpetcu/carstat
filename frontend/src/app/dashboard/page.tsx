      ...
      <section className="pt-8 px-6 max-w-7xl mx-auto">
        ...
        <div className="flex border-b border-gray-200 mb-6 overflow-x-auto">
          <button
            ...
            className={`px-4 py-2 font-medium text-sm whitespace-nowrap ${activeTab === "all"
          ...
          <button
            ...
            className={`px-4 py-2 font-medium text-sm whitespace-nowrap ${activeTab === "brands"
              ? "text-blue-600 border-b-2 border-blue-600"
              : "text-gray-500 hover:text-gray-700"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 font-medium text-sm whitespace-nowrap ${activeTab === "pricing"
              ? "text-blue-600 border-b-2 border-blue-600"
              : "text-gray-500 hover:text-gray-700"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 font-medium text-sm whitespace-nowrap ${activeTab === "price-drops"
              ? "text-blue-600 border-b-2 border-blue-600"
              : "text-gray-500 hover:text-gray-700"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 font-medium text-sm whitespace-nowrap ${activeTab === "vehicle-quality"
              ? "text-blue-600 border-b-2 border-blue-600"
              : "text-gray-500 hover:text-gray-700"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 font-medium text-sm whitespace-nowrap ${activeTab === "geographic"
              ? "text-blue-600 border-b-2 border-blue-600"
              : "text-gray-500 hover:text-gray-700"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 font-medium text-sm whitespace-nowrap ${activeTab === "mileage-impact"
              ? "text-blue-600 border-b-2 border-blue-600"
              : "text-gray-500 hover:text-gray-700"
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 font-medium text-sm whitespace-nowrap ${activeTab === "suspicious"
              ? "text-blue-600 border-b-2 border-blue-600"
              : "text-gray-500 hover:text-gray-700"
              }`}
          >
              ...
              <div className="flex flex-wrap gap-2 ml-4">
                {modelDepreciation.slice(0, 5).map((model, idx) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg text-xs whitespace-nowrap ${(selectedDepreciationModel?.brand === model.brand &&
              ...
              <div className="flex flex-wrap gap-2 ml-4">
                {generationAnalysis.slice(0, 4).map((item, idx) => (
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg text-xs whitespace-nowrap ${(selectedGenerationModel?.brand === item.brand &&
